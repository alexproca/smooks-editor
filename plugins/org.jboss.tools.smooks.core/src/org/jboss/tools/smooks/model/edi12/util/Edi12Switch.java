...
public class Edi12Switch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Edi12Package.EDI12_DOCUMENT_ROOT: {
				EDI12DocumentRoot edi12DocumentRoot = (EDI12DocumentRoot)theEObject;
				Object result = caseEDI12DocumentRoot(edi12DocumentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Edi12Package.EDI12_READER: {
				EDI12Reader edi12Reader = (EDI12Reader)theEObject;
				Object result = caseEDI12Reader(edi12Reader);
				if (result == null) result = caseAbstractReader(edi12Reader);
				if (result == null) result = caseAbstractResourceConfig(edi12Reader);
				if (result == null) result = caseAbstractAnyType(edi12Reader);
				if (result == null) result = caseAnyType(edi12Reader);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EDI12 Document Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EDI12 Document Root</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EDI12 Reader</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EDI12 Reader</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
